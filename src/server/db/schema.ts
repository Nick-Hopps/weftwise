...
export const pendingActions = sqliteTable(
  ...
  (t) => ({
    ...
    operationCheck: check(
      ...
      sql`${t.operation} IN ('create','update','patch','delete','reenrich','metadata-patch','link-ensure','history-revert','workflow-reenrich-start','workflow-research-start','workflow-image-insert-start','workflow-cancel','move','tag-batch')`,
    ),
    statusCheck: check(
