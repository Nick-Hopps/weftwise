...
export const wikiPreviewChangeTool: ToolDef<PreviewChangeInput, PendingActionView> = {
  ...
  source: 'builtin',
  description: 'Plan one explicit wiki create, update, patch, delete, re-enrich, metadata-patch, or link-ensure request. Returns a preview that requires a separate user approval actionId; it does not modify the wiki.',
