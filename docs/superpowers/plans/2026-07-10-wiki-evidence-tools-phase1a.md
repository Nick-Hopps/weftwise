...
- [ ] **Step 3: 实现共享 stale 判定并替换 lint 内联逻辑**
...
- [ ] **Step 1: 在 contracts 中声明 inspect 类型并写失败测试**
...
- [ ] **Step 4: 运行 inspect 与 repo 测试确认 GREEN**
...
- [ ] **Step 3: 实现 cursor 编解码、排序、筛选和 factory**
...
- [ ] **Step 4: 运行全部 evidence reader 测试确认 GREEN**
...
- [ ] **Step 1: 写 builtin、scope 与 runner 装配失败测试**
...
- [ ] **Step 3: 实现三个 ToolDef 与分页 `wiki.list`**
...
- [ ] **Step 4: 注入 evidence reader 并扩展 scope wrapper**
...
- [ ] **Step 1: 更新 Agents 与 Services 文档**
