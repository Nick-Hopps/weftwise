...
CREATE TABLE `__new_pending_actions` (
	...
	CONSTRAINT "pending_actions_operation_check" CHECK("__new_pending_actions"."operation" IN ('create','update','patch','delete','reenrich','metadata-patch','link-ensure','history-revert','workflow-reenrich-start','workflow-research-start','workflow-cancel')),
