...
| 2026-04-21 | `e5b7117b` | _pending_ | refactor(ui): Graph 组件首次加载/高亮/全屏切换体验三连优化 | animate:false + fade-in 消除布局跳变；class+z-index 三级高亮；全屏切换保留节点位置、zoom 快照机制；SimulationHandle.freeze() 防 gravity 漂移；a11y 与 motion-safe 全覆盖 | — | low |
